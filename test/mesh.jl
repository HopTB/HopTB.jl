...
@testset "Meshes" begin
    # endboundary = false
    mesh = Hop.Meshes.UniformMesh([3, 4, 5]; startpoint=[0.1, 0.2, 0.3], regionsize=[1.0, 2.0, 3.0])
    ...
    @test Hop.Meshes.find_point_in_mesh(mesh[29], mesh) == [2, 2, 3]
    # endboundary = true
    mesh = Hop.Meshes.UniformMesh([3, 4, 5];
